		...
		<div class="head">
			<div class="pull-right">
				<div class="nav-btn text-right">
					<div class="btn-group">
						<button type="button" class="btn btn-default btn-flat" disabled><i class="fa fa-angle-left"></i> Prev</button>
						<button type="button" class="btn btn-default btn-flat">Next <i class="fa fa-angle-right"></i></button>
					</div>
				</div>
			</div>

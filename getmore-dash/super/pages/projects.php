	...
	<div class="message">
			...
			<div class="filter-box">
				...
				<div class="filters">
					<form class="form-inline" role="form">
						...
						<div class="form-group">
							<input type="text" class="form-control" placeholder="Search keyword..." id="datatable-searchproperties" style="min-width: 300px;">
						</div>
						<div class="form-group">
		...
		<div class="mail">
			<div class="table-responsive">
				<table class="table no-border hover" id="datatable-leads">

<div class="container-fluid" id="pcont">
	<div class="message">
		...
		<div class="sub-head clearfix">
			...
			<div class="pull-right">
				<input type="text" class="form-control" placeholder="Search" id="datatable-search" style="min-width: 300px;">
			</div>
			<div class="pull-left">
				<form class="form-inline" role="form">
					<div class="form-group">
			...
			<div class="table-responsive">
				<table class="table no-border hover" id="datatable">
					...
					<tbody class="no-border-y">
						...
						<tr>
							<td><input type="checkbox" /></td>
							<td>rodel s. surquia jr.</td>
							<td>Bloq</td>
							<td>9214650557</td>
							<td>sdefine.01@aol.com</td>
							<td>Norway</td>
							<td>Hot Lead</td>
							<td>Balikbayan</td>
							<td>
